...
## SMSC Ethernet PHY
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports phy_col_0]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports phy_crs_0]
#set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { eth_mdc }]; #IO_L14N_T2_SRCC_15 Sch=eth_mdc
#set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { eth_mdio }]; #IO_L17P_T2_A26_15 Sch=eth_mdio
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports eth_ref_clk]
set_property -dict {PACKAGE_PIN C16 IOSTANDARD LVCMOS33} [get_ports phy_rst_n_0]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS33} [get_ports phy_rx_clk_0]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports phy_dv_0]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {phy_rx_data_0[0]}]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports {phy_rx_data_0[1]}]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports {phy_rx_data_0[2]}]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports {phy_rx_data_0[3]}]
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports phy_rx_er_0]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports phy_tx_clk_0]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports phy_tx_en_0]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {phy_tx_data_0[0]}]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports {phy_tx_data_0[1]}]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {phy_tx_data_0[2]}]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {phy_tx_data_0[3]}]
...
## Switches
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS33} [get_ports ni_reset]
set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS33} [get_ports ni_enable_in]
set_property -dict {PACKAGE_PIN C10 IOSTANDARD LVCMOS33} [get_ports ni_enable_clr]
#set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { sw[3] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]

## RGB LEDs

set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS33} [get_ports ni_enable_out]
#set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { led0_g }]; #IO_L19N_T3_VREF_35 Sch=led0_g
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { led0_r }]; #IO_L19P_T3_35 Sch=led0_r
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { puma_led1_b }]; #IO_L20P_T3_35 Sch=led1_b
set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { puma_led1_g }]; #IO_L21P_T3_DQS_35 Sch=led1_g
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { puma_led1_r }]; #IO_L20N_T3_35 Sch=led1_r
...
## LEDs
set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS33} [get_ports ip_btn_out_1]
set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports ip_btn_out_2]
#set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS33} [get_ports ip_btn_out_3]
#set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports ip_btn_out_4]

## Buttons
set_property -dict {PACKAGE_PIN D9 IOSTANDARD LVCMOS33} [get_ports ip_btn_in_1]
set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33} [get_ports ip_btn_in_2]
#set_property -dict {PACKAGE_PIN B9 IOSTANDARD LVCMOS33} [get_ports ip_btn_in_3]
#set_property -dict {PACKAGE_PIN B8 IOSTANDARD LVCMOS33} [get_ports ip_btn_in_4]
